...
<body id="page-top">
    ...
    <script src="admin/admin/js/sb-admin-2.min.js"></script>

    <!-- Page level plugins -->
    <script src="admin/admin/vendor/chart.js/Chart.min.js"></script>

    <!-- Page level custom scripts -->
    <script src="admin/admin/js/demo/chart-area-demo.js"></script>
    <script src="admin/admin/js/demo/chart-pie-demo.js"></script>
